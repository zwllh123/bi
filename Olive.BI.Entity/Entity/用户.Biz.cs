...
public partial class User : Entity<User>
{
    ...
    static User()
    {
        ...
        // sc.Expire = 60;
        sc.FindSlaveKeyMethod = k => Find(_.LoginName == k);
        sc.GetSlaveKeyMethod = e => e.LoginName;
    }
    ...
    public override Boolean Valid(DataMethod method)
    {
        ...
        if (RealName == null) throw new ArgumentNullException(nameof(RealName), "真实姓名不能为空！");
        if (Password == null) throw new ArgumentNullException(nameof(Password), "密码不能为空！");
        ...
        // 检查唯一索引
        // CheckExist(method == DataMethod.Insert, nameof(LoginName));
