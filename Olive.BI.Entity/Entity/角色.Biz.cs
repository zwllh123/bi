...
public partial class Role : Entity<Role>
{
    ...
    static Role()
    {
        ...
        // sc.Expire = 60;
        sc.FindSlaveKeyMethod = k => Find(_.RoleCode == k);
        sc.GetSlaveKeyMethod = e => e.RoleCode;
    }
    ...
    public override Boolean Valid(DataMethod method)
    {
        ...
        if (RoleName == null) throw new ArgumentNullException(nameof(RoleName), "角色名称不能为空！");
        ...
        // 检查唯一索引
        // CheckExist(method == DataMethod.Insert, nameof(RoleCode));
