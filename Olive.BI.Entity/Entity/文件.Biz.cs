...
public partial class GaeaFile : Entity<GaeaFile>
{
    #region 对象操作
    ...
    //    if (XTrace.Debug) XTrace.WriteLine("开始初始化GaeaFile[文件]数据……");
    ...
    //    entity.FilePath = "abc";
    //    entity.UrlPath = "abc";
    //    entity.FileInstruction = "abc";
    //    entity.Version = 0;
    //    entity.Insert();

    //    if (XTrace.Debug) XTrace.WriteLine("完成初始化GaeaFile[文件]数据！");
    //}
    ...
    #region 业务操作
    public GaeaFileEntity ToModel()
    {
        var model = new GaeaFileEntity();
        model.Copy(this);
